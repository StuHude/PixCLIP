...
import sys
import argparse
from load_urbank import UrbankDataset
import os
...
if __name__ == "__main__":
    ...
    parser.add_argument("--clip_type", type=str, default="EVA02-CLIP-B-16", help="The Type of PixCLIP model")
    parser.add_argument("--ckpt", type=str, required=True, help="Checkpoint path")
    parser.add_argument("--root-dir", type=str, default="./data/Urban1k", help="Urban1k data directory")
