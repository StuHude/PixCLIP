...
if __name__ == "__main__":
    ...
    parser.add_argument("--xiaoclip_ckpt", type=str, default=None, help="XiaoCLIP checkpoint for aclip cp0.0")
    ...
    executor = ClipExecutor(clip_model=args.clip_model,
                            box_representation_method=args.box_representation_method,
                            method_aggregator=args.box_method_aggregator,
                            device=device,
                            square_size=not args.non_square_size,
                            expand_position_embedding=args.expand_position_embedding,
                            blur_std_dev=args.blur_std_dev,
                            cache_path=args.cache_path,
                            input_file=args.input_file,
                            clip_type=args.clip_type,
                            xiaoclip_ckpt=args.xiaoclip_ckpt)
